 ...
 * @see Cloneable
 */
public interface BaseEntity extends Serializable, Comparable<BaseEntity>, Cloneable {

	/**
	 * Metodo <b>fillBeanFromMap</b> possui a função de preencher um
	 * <em>{@link BaseEntity}</em> a partir de um <em>{@link Map}</em>.
	 *
	 * @param map
	 *            Map
	...
	/**
	 * Metodo <b>toMap</b> possui a função de retorna uma <em>{@link Map}</em>
	...
	/**
	 * Metodo <b>toXml</b> possui a função de retorna uma
	 * <em>{@link String}</em> que representa o xml do objeto.
	 *
	 * @return xml String
	 * @throws SigecoException
	 */
