...
public class Constant {
	...
	public static final String PREFIX_NAME_IS_METHOD = "is";
	public static final String PREFIX_NAME_SET_METHOD = "set";
	public static final String SPEC_PACKAGE_NAME = "";
	public static final String SUFIX_CLASS_NAME = "";
	public static final String VERSAO_NODE_XML = "versao";
